...
using tenantpropertymanagement.Blazor.Server.Services;
...
namespace tenantpropertymanagement.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                builder.UseApplication<tenantpropertymanagementBlazorApplication>();
                builder.Modules
                    .AddAuditTrailEFCore()
                    .AddCloning()
                    ...
                    .AddViewVariants()
                    .Add<tenantpropertymanagement.Module.tenantpropertymanagementModule>()
                    .Add<tenantpropertymanagementBlazorModule>();
                builder.ObjectSpaceProviders
                    ...
                    {
                        contexts.Configure<tenantpropertymanagement.Module.BusinessObjects.tenantpropertymanagementEFCoreDbContext, tenantpropertymanagement.Module.BusinessObjects.tenantpropertymanagementAuditingDbContext>(
                ...
                builder.Security
                    .UseIntegratedMode(options =>
                    {
                        ...
                        options.UserType = typeof(tenantpropertymanagement.Module.BusinessObjects.ApplicationUser);
                        // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                        // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                        options.UserLoginInfoType = typeof(tenantpropertymanagement.Module.BusinessObjects.ApplicationUserLoginInfo);
