...
namespace tenantpropertymanagement.Module
{
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed class tenantpropertymanagementModule : ModuleBase
    {
        public tenantpropertymanagementModule()
        {
            //
            // tenantpropertymanagementModule
            //
            AdditionalExportedTypes.Add(typeof(tenantpropertymanagement.Module.BusinessObjects.ApplicationUser));
